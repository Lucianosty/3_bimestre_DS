...
namespace Gerenciador_de_Tarefas_Com_MySQL
{
    public partial class FormCriar : Form
    {
        ...
        private void btCriar_Click(object sender, EventArgs e)
        {
            ...
            Conexao.DadosGlobais.vStatus = cbStatus.SelectedItem != null ? cbStatus.SelectedItem.ToString() : "Pendente"; // Pega o status selecionado ou define como "Pendente" se nada for selecionado
